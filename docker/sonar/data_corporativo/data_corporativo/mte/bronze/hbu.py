...
url = "https://mte-produccion.azure-api.net/data/v1/hBU/Items"
...
schema = StructType([
    ...
    StructField("EsSector", BooleanType(), True),
...
mte_formatted.write.mode("overwrite").format("delta").option("overwriteSchema", "true").option("mergeSchema", "true").saveAsTable('operaciones.bronze_mte.hBU')
mte_formatted.write.mode("overwrite").format("delta").option("overwriteSchema", "true").option("mergeSchema", "true").saveAsTable('people.bronze_mte.hBU')