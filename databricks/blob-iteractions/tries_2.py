...
def get_client(file_system_name: str) -> FileSystemClient:
  ...
  """
  connection_string = "DefaultEndpointsProtocol=https;AccountName=seguiturdatalake;AccountKey=UbQ5nxZDw/4OMoNmpqc14EVftt2XE1vpfwV4EHXdfwc8w9HT1AHeInZdUy3YuFo2Q1rq3lkMYiAdaVXtYVDRtg==;EndpointSuffix=core.windows.net"
...
# file_system_client = get_client("ficheros-test-txt")
...
def upload_file_from_bytes(
  ...
  filename: str, 
  path: str, 
  file_system_name: str = "blob-test-container-txt") -> None:
...
blob_list = get_all_files(f"/dbfs/mnt/blob-test-container/")
...
folders = ["15Bodegas", '20-minutos', 
           "2022-17443-mango-portal-corporativo","2022-18015-mango-portal-startup-studio",
           "2023-18990-synectic-migracion-de-los-portales-publicos"]
...
for file in tqdm(blob_list, total=len(blob_list)):
    filename = file.split("/")[-1]
    # print(filename)
    with open(file, "rb") as file_1:
      content = file_1.read()
