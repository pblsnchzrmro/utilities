...
file_name = 'ipc_nacional_media_anual'
ipc_nacional_media_anual_bp = Blueprint('ipc_nacional_media_anual', __name__)

@ipc_nacional_media_anual_bp.route('/IPC_NACIONAL_MEDIA_ANUAL_DL', methods=['GET'])
def ipc_nacional_media_anual_dl():
    ...
    rubrics = ["Índice general", "Turismo y hostelería"]
    ...
    logging.info("Parameters: {}, {}, {}, {}, {}...".format(
        start_month, start_year, end_month, end_year, rubrics))
    ...
    if (start_month and not start_year) or ((end_year or end_month) and not (start_year and start_month)) or not file_type in [".csv", ".xlsx"]:
        ...
        df = read_blob_file("/IPC/ipc_nacional_media_anual.csv", fields,
        ...
        header = {
            "Content-Disposition": "attachment; filename=ipc_nacional_media_anual" + file_type}
