...
dbutils.widgets.text(
    "model_name", "dev.test_stack_mlops.my_mlops_project-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.test_stack_mlops.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.test_stack_mlops.trip_dropoff_features",
