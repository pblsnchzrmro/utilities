...
Links:
* [Staging model in UC](https://adb-3842051123482980.0.azuredatabricks.net/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://adb-3842051123482980.0.azuredatabricks.net/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 
