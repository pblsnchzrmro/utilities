...
file_name = 'valores_climatologicos_precipitacion'
valores_climatologicos_precipitacion_bp = Blueprint('valores_climatologicos_precipitacion', __name__)

@valores_climatologicos_precipitacion_bp.route('/VALORES_CLIMATOLOGICOS_PRECIPITACION_DL', methods=['GET'])
def valores_climatologicos_precipitacion_dl():
