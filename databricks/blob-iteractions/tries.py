...
blobContainerName = "all-ficheros-text"
dbutils.fs.mount(
...
def copy_files(src_container_name: str, dest_container_name: str, supported_extensions: list, src_folder: str, path: str = "/") -> None:
    ...
    blob_list = list(src_container_client.list_blobs(name_starts_with=src_folder))[:1]  # transform to list
...
copy_files("ficheros", "all-ficheros-text", supported_extensions, "/gitlab")