...
file_name = 'ipc_nacional'
ipc_nacional_bp = Blueprint('ipc_nacional', __name__)

@ipc_nacional_bp.route('/IPC_NACIONAL_DL', methods=['GET'])
def ipc_nacional_dl():
    ...
    if (start_month and not start_year) or ((end_year or end_month) and not (start_year and start_month)) or not file_type in [".csv", ".xlsx"]:
        ...
        df = read_blob_file("/IPC/ipc_nacional.csv", fields,
        ...
        header = {
            "Content-Disposition": "attachment; filename=ipc_nacional" + file_type}
