...
# MAGIC To run this demo, just select the cluster `dbdemos-cdc-pipeline-psanchezr` from the dropdown menu ([open cluster configuration](https://adb-2580918058532516.16.azuredatabricks.net/#setting/clusters/0302-120724-sm6upeu0/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=2580918058532516&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fcdc-pipeline%2F02-CDC-CDF-full-multi-tables&uid=7159578847125396">
