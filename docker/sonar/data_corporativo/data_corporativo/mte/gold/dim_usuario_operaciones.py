...
df = df.select('NombreCompleto', 'ID','EmailCorporativo','CodigoProyecto','CodigoProyectoVAC', 'CodigoProyectoPER','Imputa','AppImputacion', 'Productividad','hMA','hBU','SubhBU','EquipoTrabajohBU','EquipoTrabajoMultiarea','Bonificable','Reasignable','EsBaja', 'FECHA_CARGA')
...
df.write.mode("overwrite").format("delta").option("overwriteSchema", "true").option("mergeSchema", "true").saveAsTable('operaciones.gold_mte.dim_usuario')
